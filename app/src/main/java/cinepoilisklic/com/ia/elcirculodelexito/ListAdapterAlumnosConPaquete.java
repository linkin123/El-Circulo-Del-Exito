...
public class ListAdapterAlumnosConPaquete extends RecyclerView.Adapter<ListAdapter.ItemViewHolder> implements Filterable {

    private ArrayList<Alumno> persons;
    private ArrayList<Alumno> personsFilter;
    private ListAdapterAlumnosConPaquete.CustomFilter mFilter;
    private ListAdapterAlumnosConPaquete.onItemClickListener mListener;
    ...
    // Constructor
    public ListAdapterAlumnosConPaquete(ArrayList<Alumno> persons , ListAdapterAlumnosConPaquete.onItemClickListener listener) {

        this.persons = persons;
        this.personsFilter = new ArrayList<>();
        this.personsFilter.addAll(persons);
        this.mFilter = new CustomFilter(ListAdapterAlumnosConPaquete.this);
        mListener = listener;
    }
    ...
    public ListAdapter.ItemViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_adapter_alumno_nuevo_paquete, parent, false);
        // creo el grupo de vistas
        ListAdapter.ItemViewHolder vh = new ListAdapter.ItemViewHolder(v);
        return vh;
    }
...
//        personsFilter.get(position).getColor();
    ...
    public class CustomFilter extends Filter {
        private ListAdapterAlumnosConPaquete listAdapterAlumnosConPaquete;

        private CustomFilter(ListAdapterAlumnosConPaquete listAdapterAlumnosConPaquete) {
            super();
            this.listAdapterAlumnosConPaquete = listAdapterAlumnosConPaquete;
        }
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            this.listAdapterAlumnosConPaquete.notifyDataSetChanged();
        }
    }
